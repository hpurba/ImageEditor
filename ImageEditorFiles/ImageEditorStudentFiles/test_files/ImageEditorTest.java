...
class ImageEditorTest {
    ...
    private static final String FEEP = "editor/feep.ppm";
    private static final String ONE_DOES_NOT = "editor/one-does-not-simply.ppm";
    private static final String PENGUINS = "editor/Penguins.ppm";
    private static final String SUNSET = "editor/sunset.ppm";
    private static final String TINY = "editor/tiny.ppm";
